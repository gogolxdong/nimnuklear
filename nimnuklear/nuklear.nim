...
type
  color* {.importc: "struct nk_color", header: headernuklear, bycopy.} = object
    r* {.importc: "r".}: byte
    g* {.importc: "g".}: byte
    b* {.importc: "b".}: byte
    a* {.importc: "a".}: byte

  colorf* {.importc: "struct nk_colorf", header: headernuklear, bycopy.} = object
    r* {.importc: "r".}: cfloat
    g* {.importc: "g".}: cfloat
    b* {.importc: "b".}: cfloat
    a* {.importc: "a".}: cfloat

  vec2* {.importc: "struct nk_vec2", header: headernuklear, bycopy.} = object
    x* {.importc: "x".}: cfloat
    y* {.importc: "y".}: cfloat

  vec2i* {.importc: "struct nk_vec2i", header: headernuklear, bycopy.} = object
    x* {.importc: "x".}: cshort
    y* {.importc: "y".}: cshort

  rect* {.importc: "struct nk_rect", header: headernuklear, bycopy.} = object
    x* {.importc: "x".}: cfloat
    y* {.importc: "y".}: cfloat
    w* {.importc: "w".}: cfloat
    h* {.importc: "h".}: cfloat

  recti* {.importc: "struct nk_recti", header: headernuklear, bycopy.} = object
    x* {.importc: "x".}: cshort
    y* {.importc: "y".}: cshort
    w* {.importc: "w".}: cshort
    h* {.importc: "h".}: cshort
  ...
  glyph* = array[4, char]
  handle* {.importc: "nk_handle", header: headernuklear, bycopy.} = object {.union.}
    `ptr`* {.importc: "ptr".}: pointer
    id* {.importc: "id".}: cint

  img* {.importc: "struct nk_image", header: headernuklear, bycopy.} = object
    handle* {.importc: "handle".}: handle
    w* {.importc: "w".}: cushort
    h* {.importc: "h".}: cushort
    region* {.importc: "region".}: array[4, cushort]

  cursor* {.importc: "struct nk_cursor", header: headernuklear, bycopy.} = object
    img* {.importc: "img".}: img
    size* {.importc: "size".}: vec2
    offset* {.importc: "offset".}: vec2

  scroll* {.importc: "struct nk_scroll", header: headernuklear, bycopy.} = object
    x* {.importc: "x".}: uint
    y* {.importc: "y".}: uint
  ...
  plugin_alloc* = proc (a1: handle; old: pointer; a3: size): pointer  {.cdecl.}
  plugin_free* = proc (a1: handle; old: pointer)  {.cdecl.}
  plugin_filter* = proc (a1: ptr text_edit; unicode: rune): cint  {.cdecl.}
  plugin_paste* = proc (a1: handle; a2: ptr text_edit)  {.cdecl.}
  plugin_copy* = proc (a1: handle; a2: cstring; len: cint)  {.cdecl.}
  allocator* {.importc: "struct nk_allocator", header: headernuklear, bycopy.} = object
  ...
  draw_null_texture* {.importc: "struct nk_draw_null_texture", header: headernuklear, bycopy.} = object
    texture* {.importc: "texture".}: handle
    uv* {.importc: "uv".}: vec2

  convert_config* {.importc: "struct nk_convert_config", header: headernuklear, bycopy.} = object
  ...
  list_view* {.importc: "struct nk_list_view", header: headernuklear, bycopy.} = object
...
#  user_font_glyph* {.importc: "struct nk_user_font_glyph", header: headernuklear, bycopy.} = object
  
  text_width_f* = proc (a1: handle; h: cfloat; a3: cstring; len: cint): cfloat 
  ...
  user_font* {.importc: "struct nk_user_font", header: headernuklear, bycopy.} = object
    userdata* {.importc: "userdata".}: handle
    height* {.importc: "height".}: cfloat
...
#  font* {.importc: "struct nk_font", header: headernuklear, bycopy.} = object
  
  baked_font* {.importc: "struct nk_baked_font", header: headernuklear, bycopy.} = object
    height* {.importc: "height".}: cfloat
  ...
  font_config* {.importc: "struct nk_font_config", header: headernuklear, bycopy.} = object
  ...
  font_glyph* {.importc: "struct nk_font_glyph", header: headernuklear, bycopy.} = object
  ...
  font_atlas* {.importc: "struct nk_font_atlas", header: headernuklear, bycopy.} = object
  ...
  memory_status* {.importc: "struct nk_memory_status", header: headernuklear, bycopy.} = object
  ...
  buffer_marker* {.importc: "struct nk_buffer_marker", header: headernuklear, bycopy.} = object
    active* {.importc: "active".}: cint
    offset* {.importc: "offset".}: size

  memory* {.importc: "struct nk_memory", header: headernuklear, bycopy.} = object
    `ptr`* {.importc: "ptr".}: pointer
    size* {.importc: "size".}: size

  buffer* {.importc: "struct nk_buffer", header: headernuklear, bycopy.} = object
  ...
  str* {.importc: "struct nk_str", header: headernuklear, bycopy.} = object
    buffer* {.importc: "buffer".}: buffer
    len* {.importc: "len".}: cint


  #text_edit* {.importc: "struct nk_text_edit", header: headernuklear, bycopy.} = object
  
  clipboard* {.importc: "struct nk_clipboard", header: headernuklear, bycopy.} = object
    userdata* {.importc: "userdata".}: handle
    paste* {.importc: "paste".}: plugin_paste
    copy* {.importc: "copy".}: plugin_copy

  text_undo_record* {.importc: "struct nk_text_undo_record", header: headernuklear, bycopy.} = object
  ...
  text_undo_state* {.importc: "struct nk_text_undo_state", header: headernuklear, bycopy.} = object
  ...
  command* {.importc: "struct nk_command", header: headernuklear, bycopy.} = object
    `type`* {.importc: "type".}: command_type
    next* {.importc: "next".}: size

  command_scissor* {.importc: "struct nk_command_scissor", header: headernuklear, bycopy.} = object
  ...
  command_line* {.importc: "struct nk_command_line", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
  ...
  command_curve* {.importc: "struct nk_command_curve", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
    line_thickness* {.importc: "line_thickness".}: cushort
    begin* {.importc: "begin".}: vec2i
    `end`* {.importc: "end".}: vec2i
  ...
  command_rect* {.importc: "struct nk_command_rect", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
  ...
  command_rect_filled* {.importc: "struct nk_command_rect_filled", header: headernuklear,
                        bycopy.} = object
    header* {.importc: "header".}: command
    rounding* {.importc: "rounding".}: cushort
    x* {.importc: "x".}: cshort
  ...
  command_rect_multi_color* {.importc: "struct nk_command_rect_multi_color",
                             header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
    x* {.importc: "x".}: cshort
    y* {.importc: "y".}: cshort
    w* {.importc: "w".}: cushort
  ...
  command_triangle* {.importc: "struct nk_command_triangle", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
    line_thickness* {.importc: "line_thickness".}: cushort
    a* {.importc: "a".}: vec2i
    b* {.importc: "b".}: vec2i
  ...
  command_circle* {.importc: "struct nk_command_circle", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
    x* {.importc: "x".}: cshort
    y* {.importc: "y".}: cshort
    line_thickness* {.importc: "line_thickness".}: cushort
  ...
  command_arc* {.importc: "struct nk_command_arc", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
  ...
  command_arc_filled* {.importc: "struct nk_command_arc_filled", header: headernuklear,
                       bycopy.} = object
    header* {.importc: "header".}: command
    cx* {.importc: "cx".}: cshort
    cy* {.importc: "cy".}: cshort
  ...
  command_polygon* {.importc: "struct nk_command_polygon", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
    color* {.importc: "color".}: color
    line_thickness* {.importc: "line_thickness".}: cushort
  ...
  command_polyline* {.importc: "struct nk_command_polyline", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
    color* {.importc: "color".}: color
    line_thickness* {.importc: "line_thickness".}: cushort
    point_count* {.importc: "point_count".}: cushort
  ...
  command_image* {.importc: "struct nk_command_image", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
    x* {.importc: "x".}: cshort
    y* {.importc: "y".}: cshort
    w* {.importc: "w".}: cushort
  ...
  command_custom* {.importc: "struct nk_command_custom", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
    x* {.importc: "x".}: cshort
    y* {.importc: "y".}: cshort
    w* {.importc: "w".}: cushort
  ...
  command_text* {.importc: "struct nk_command_text", header: headernuklear, bycopy.} = object
    header* {.importc: "header".}: command
  ...
  command_buffer* {.importc: "struct nk_command_buffer", header: headernuklear, bycopy.} = object
  ...
  mouse_button* {.importc: "struct nk_mouse_button", header: headernuklear, bycopy.} = object
    down* {.importc: "down".}: cint
    clicked* {.importc: "clicked".}: cuint
    clicked_pos* {.importc: "clicked_pos".}: vec2

  mouse* {.importc: "struct nk_mouse", header: headernuklear, bycopy.} = object
  ...
  key* {.importc: "struct nk_key", header: headernuklear, bycopy.} = object
    down* {.importc: "down".}: cint
    clicked* {.importc: "clicked".}: cuint

  keyboard* {.importc: "struct nk_keyboard", header: headernuklear, bycopy.} = object
    keys* {.importc: "keys".}: array[KEY_MAX, key]
    text* {.importc: "text".}: array[16, char]
    text_len* {.importc: "text_len".}: cint

  input* {.importc: "struct nk_input", header: headernuklear, bycopy.} = object
  ...
  draw_command* {.importc: "struct nk_draw_command", header: headernuklear, bycopy.} = object
    elem_count* {.importc: "elem_count".}: cuint
    clip_rect* {.importc: "clip_rect".}: rect
    texture* {.importc: "texture".}: handle

  draw_list* {.importc: "struct nk_draw_list", header: headernuklear, bycopy.} = object
    clip_rect* {.importc: "clip_rect".}: rect
  ...
  style_item_data* {.importc: "nk_style_item_data", header: headernuklear, bycopy.} = object {.
      union.}
    img* {.importc: "image".}: img
    color* {.importc: "color".}: color

  style_item* {.importc: "struct nk_style_item", header: headernuklear, bycopy.} = object
    `type`* {.importc: "type".}: style_item_type
    data* {.importc: "data".}: style_item_data

  style_text* {.importc: "struct nk_style_text", header: headernuklear, bycopy.} = object
    color* {.importc: "color".}: color
    padding* {.importc: "padding".}: vec2

  style_button* {.importc: "struct nk_style_button", header: headernuklear, bycopy.} = object
    ...
    userdata* {.importc: "userdata".}: handle
    draw_begin* {.importc: "draw_begin".}: proc (a1: ptr command_buffer;
        userdata: handle) {.cdecl.}
    draw_end* {.importc: "draw_end".}: proc (a1: ptr command_buffer; userdata: handle) {.
        cdecl.}

  style_toggle* {.importc: "struct nk_style_toggle", header: headernuklear, bycopy.} = object
    normal* {.importc: "normal".}: style_item
    hover* {.importc: "hover".}: style_item
    active* {.importc: "active".}: style_item
    border_color* {.importc: "border_color".}: color
    ...
    border* {.importc: "border".}: cfloat
    userdata* {.importc: "userdata".}: handle
    draw_begin* {.importc: "draw_begin".}: proc (a1: ptr command_buffer; a2: handle) {.
        cdecl.}
    draw_end* {.importc: "draw_end".}: proc (a1: ptr command_buffer; a2: handle) {.cdecl.}

  style_selectable* {.importc: "struct nk_style_selectable", header: headernuklear, bycopy.} = object
    normal* {.importc: "normal".}: style_item
    hover* {.importc: "hover".}: style_item
  ...
  style_slider* {.importc: "struct nk_style_slider", header: headernuklear, bycopy.} = object
    normal* {.importc: "normal".}: style_item
    hover* {.importc: "hover".}: style_item
    active* {.importc: "active".}: style_item
    border_color* {.importc: "border_color".}: color
  ...
  style_progress* {.importc: "struct nk_style_progress", header: headernuklear, bycopy.} = object
    normal* {.importc: "normal".}: style_item
    hover* {.importc: "hover".}: style_item
    active* {.importc: "active".}: style_item
    border_color* {.importc: "border_color".}: color
  ...
  style_scrollbar* {.importc: "struct nk_style_scrollbar", header: headernuklear, bycopy.} = object
    normal* {.importc: "normal".}: style_item
    hover* {.importc: "hover".}: style_item
    active* {.importc: "active".}: style_item
    border_color* {.importc: "border_color".}: color
  ...
  style_edit* {.importc: "struct nk_style_edit", header: headernuklear, bycopy.} = object
    normal* {.importc: "normal".}: style_item
    hover* {.importc: "hover".}: style_item
    active* {.importc: "active".}: style_item
    border_color* {.importc: "border_color".}: color
  ...
  style_property* {.importc: "struct nk_style_property", header: headernuklear, bycopy.} = object
    normal* {.importc: "normal".}: style_item
    hover* {.importc: "hover".}: style_item
    active* {.importc: "active".}: style_item
    border_color* {.importc: "border_color".}: color
  ...
  style_chart* {.importc: "struct nk_style_chart", header: headernuklear, bycopy.} = object
  ...
  style_combo* {.importc: "struct nk_style_combo", header: headernuklear, bycopy.} = object
    normal* {.importc: "normal".}: style_item
    hover* {.importc: "hover".}: style_item
    active* {.importc: "active".}: style_item
    border_color* {.importc: "border_color".}: color
  ...
  style_tab* {.importc: "struct nk_style_tab", header: headernuklear, bycopy.} = object
    background* {.importc: "background".}: style_item
    border_color* {.importc: "border_color".}: color
  ...
  style_window_header* {.importc: "struct nk_style_window_header", header: headernuklear,
                        bycopy.} = object
    normal* {.importc: "normal".}: style_item
    hover* {.importc: "hover".}: style_item
    active* {.importc: "active".}: style_item
  ...
  style_window* {.importc: "struct nk_style_window", header: headernuklear, bycopy.} = object
  ...
  style* {.importc: "struct nk_style", header: headernuklear, bycopy.} = object
    font* {.importc: "font".}: ptr user_font
  ...
  chart_slot* {.importc: "struct nk_chart_slot", header: headernuklear, bycopy.} = object
  ...
  chart* {.importc: "struct nk_chart", header: headernuklear, bycopy.} = object
  ...
  row_layout* {.importc: "struct nk_row_layout", header: headernuklear, bycopy.} = object
  ...
  popup_buffer* {.importc: "struct nk_popup_buffer", header: headernuklear, bycopy.} = object
    begin* {.importc: "begin".}: size
  ...
  menu_state* {.importc: "struct nk_menu_state", header: headernuklear, bycopy.} = object
    x* {.importc: "x".}: cfloat
    y* {.importc: "y".}: cfloat
    w* {.importc: "w".}: cfloat
    h* {.importc: "h".}: cfloat
  ...
  panel* {.importc: "struct nk_panel", header: headernuklear, bycopy.} = object
...
#  table* {.importc: "struct nk_table", header: headernuklear, bycopy.} = object
  ...
  popup_state* {.importc: "struct nk_popup_state", header: headernuklear, bycopy.} = object
  ...
  edit_state* {.importc: "struct nk_edit_state", header: headernuklear, bycopy.} = object
    name* {.importc: "name".}: hash
  ...
  property_state* {.importc: "struct nk_property_state", header: headernuklear, bycopy.} = object
    active* {.importc: "active".}: cint
    prev* {.importc: "prev".}: cint
  ...
  window* {.importc: "struct nk_window", header: headernuklear, bycopy.} = object
    seq* {.importc: "seq".}: cuint
    name* {.importc: "name".}: hash
  ...
  config_stack_button_behavior_element* {.
      importc: "struct nk_config_stack_button_behavior_element", header: headernuklear,
      bycopy.} = object
  ...
  config_stack_float* {.importc: "struct nk_config_stack_float", header: headernuklear,
                       bycopy.} = object
    head* {.importc: "head".}: cint
    elements* {.importc: "elements".}: array[32, config_stack_float_element]

  config_stack_vec2* {.importc: "struct nk_config_stack_vec2", header: headernuklear, bycopy.} = object
    head* {.importc: "head".}: cint
    elements* {.importc: "elements".}: array[16, config_stack_vec2_element]

  config_stack_flags* {.importc: "struct nk_config_stack_flags", header: headernuklear,
                       bycopy.} = object
    head* {.importc: "head".}: cint
    elements* {.importc: "elements".}: array[32, config_stack_flags_element]

  config_stack_color* {.importc: "struct nk_config_stack_color", header: headernuklear,
                       bycopy.} = object
    head* {.importc: "head".}: cint
  ...
  configuration_stacks* {.importc: "struct nk_configuration_stacks",
                         header: headernuklear, bycopy.} = object
  ...
  page_data* {.importc: "nk_page_data", header: headernuklear, bycopy.} = object {.union.}
    tbl* {.importc: "tbl".}: table
    pan* {.importc: "pan".}: panel
    win* {.importc: "win".}: window

  page_element* {.importc: "struct nk_page_element", header: headernuklear, bycopy.} = object
    data* {.importc: "data".}: page_data
    next* {.importc: "next".}: ptr page_element
    prev* {.importc: "prev".}: ptr page_element

  page* {.importc: "struct nk_page", header: headernuklear, bycopy.} = object
    size* {.importc: "size".}: cuint
    next* {.importc: "next".}: ptr page
    win* {.importc: "win".}: array[1, page_element]

  pool* {.importc: "struct nk_pool", header: headernuklear, bycopy.} = object
  ...
  context* {.importc: "struct nk_context", header: headernuklear, bycopy.} = object
...
proc style_item_hide*(): style_item {.cdecl, importc: "nk_style_item_hide",
                                   header: headernuklear.}
proc style_item_color*(a1: color): style_item {.cdecl,
...
proc draw_list_add_text*(a1: ptr draw_list; a2: ptr user_font; a3: rect; text: cstring;
                        len: cint; font_height: cfloat; a7: color) {.cdecl,
    importc: "nk_draw_list_add_text", header: headernuklear.}
proc draw_list_add_image*(a1: ptr draw_list; texture: img; rect: rect; a4: color) {.
    cdecl, importc: "nk_draw_list_add_image", header: headernuklear.}
proc draw_list_fill_poly_convex*(a1: ptr draw_list; points: ptr vec2; count: cuint;
                                a4: color; a5: anti_aliasing) {.cdecl,
    importc: "nk_draw_list_fill_poly_convex", header: headernuklear.}
proc draw_list_fill_circle*(a1: ptr draw_list; center: vec2; radius: cfloat; col: color;
                           segs: cuint) {.cdecl,
                                        importc: "nk_draw_list_fill_circle",
                                        header: headernuklear.}
proc draw_list_fill_triangle*(a1: ptr draw_list; a: vec2; b: vec2; c: vec2; a5: color) {.
    cdecl, importc: "nk_draw_list_fill_triangle", header: headernuklear.}
proc draw_list_fill_rect_multi_color*(a1: ptr draw_list; rect: rect; left: color;
                                     top: color; right: color; bottom: color) {.cdecl,
    importc: "nk_draw_list_fill_rect_multi_color", header: headernuklear.}
proc draw_list_fill_rect*(a1: ptr draw_list; rect: rect; a3: color; rounding: cfloat) {.
    cdecl, importc: "nk_draw_list_fill_rect", header: headernuklear.}
proc draw_list_stroke_poly_line*(a1: ptr draw_list; pnts: ptr vec2; cnt: cuint;
                                a4: color; a5: draw_list_stroke; thickness: cfloat;
                                a7: anti_aliasing) {.cdecl,
    importc: "nk_draw_list_stroke_poly_line", header: headernuklear.}
proc draw_list_stroke_curve*(a1: ptr draw_list; p0: vec2; cp0: vec2; cp1: vec2; p1: vec2;
                            a6: color; segments: cuint; thickness: cfloat) {.cdecl,
    importc: "nk_draw_list_stroke_curve", header: headernuklear.}
proc draw_list_stroke_circle*(a1: ptr draw_list; center: vec2; radius: cfloat;
                             a4: color; segs: cuint; thickness: cfloat) {.cdecl,
    importc: "nk_draw_list_stroke_circle", header: headernuklear.}
proc draw_list_stroke_triangle*(a1: ptr draw_list; a: vec2; b: vec2; c: vec2; a5: color;
                               thickness: cfloat) {.cdecl,
    importc: "nk_draw_list_stroke_triangle", header: headernuklear.}
proc draw_list_stroke_rect*(a1: ptr draw_list; rect: rect; a3: color; rounding: cfloat;
                           thickness: cfloat) {.cdecl,
    importc: "nk_draw_list_stroke_rect", header: headernuklear.}
proc draw_list_stroke_line*(a1: ptr draw_list; a: vec2; b: vec2; a4: color;
                           thickness: cfloat) {.cdecl,
    importc: "nk_draw_list_stroke_line", header: headernuklear.}
proc draw_list_path_stroke*(a1: ptr draw_list; a2: color; closed: draw_list_stroke;
                           thickness: cfloat) {.cdecl,
    importc: "nk_draw_list_path_stroke", header: headernuklear.}
proc draw_list_path_fill*(a1: ptr draw_list; a2: color) {.cdecl,
    importc: "nk_draw_list_path_fill", header: headernuklear.}
proc draw_list_path_curve_to*(a1: ptr draw_list; p2: vec2; p3: vec2; p4: vec2;
                             num_segments: cuint) {.cdecl,
    importc: "nk_draw_list_path_curve_to", header: headernuklear.}
proc draw_list_path_rect_to*(a1: ptr draw_list; a: vec2; b: vec2; rounding: cfloat) {.
    cdecl, importc: "nk_draw_list_path_rect_to", header: headernuklear.}
proc draw_list_path_arc_to*(a1: ptr draw_list; center: vec2; radius: cfloat;
                           a_min: cfloat; a_max: cfloat; segments: cuint) {.cdecl,
    importc: "nk_draw_list_path_arc_to", header: headernuklear.}
proc draw_list_path_arc_to_fast*(a1: ptr draw_list; center: vec2; radius: cfloat;
                                a_min: cint; a_max: cint) {.cdecl,
    importc: "nk_draw_list_path_arc_to_fast", header: headernuklear.}
proc draw_list_path_line_to*(a1: ptr draw_list; pos: vec2) {.cdecl,
    importc: "nk_draw_list_path_line_to", header: headernuklear.}
proc draw_list_path_clear*(a1: ptr draw_list) {.cdecl,
    importc: "nk_draw_list_path_clear", header: headernuklear.}
proc draw_list_end*(a1: ptr draw_list; a2: ptr buffer): ptr draw_command {.cdecl,
    importc: "nk__draw_list_end", header: headernuklear.}
proc draw_list_next*(a1: ptr draw_command; a2: ptr buffer; a3: ptr draw_list): ptr draw_command {.
    cdecl, importc: "nk__draw_list_next", header: headernuklear.}
proc draw_list_begin*(a1: ptr draw_list; a2: ptr buffer): ptr draw_command {.cdecl,
    importc: "nk__draw_list_begin", header: headernuklear.}
proc draw_list_setup*(a1: ptr draw_list; a2: ptr convert_config; cmds: ptr buffer;
...
proc draw_list_init*(a1: ptr draw_list) {.cdecl, importc: "nk_draw_list_init",
                                      header: headernuklear.}
proc input_is_key_down*(a1: ptr input; a2: keys): cint {.cdecl,
    importc: "nk_input_is_key_down", header: headernuklear.}
proc input_is_key_released*(a1: ptr input; a2: keys): cint {.cdecl,
    importc: "nk_input_is_key_released", header: headernuklear.}
proc input_is_key_pressed*(a1: ptr input; a2: keys): cint {.cdecl,
    importc: "nk_input_is_key_pressed", header: headernuklear.}
proc input_is_mouse_released*(a1: ptr input; a2: buttons): cint {.cdecl,
    importc: "nk_input_is_mouse_released", header: headernuklear.}
proc input_is_mouse_pressed*(a1: ptr input; a2: buttons): cint {.cdecl,
    importc: "nk_input_is_mouse_pressed", header: headernuklear.}
proc input_is_mouse_down*(a1: ptr input; a2: buttons): cint {.cdecl,
    importc: "nk_input_is_mouse_down", header: headernuklear.}
proc input_mouse_clicked*(a1: ptr input; a2: buttons; a3: rect): cint {.cdecl,
    importc: "nk_input_mouse_clicked", header: headernuklear.}
proc input_is_mouse_hovering_rect*(a1: ptr input; a2: rect): cint {.cdecl,
    importc: "nk_input_is_mouse_hovering_rect", header: headernuklear.}
proc input_is_mouse_prev_hovering_rect*(a1: ptr input; a2: rect): cint {.cdecl,
    importc: "nk_input_is_mouse_prev_hovering_rect", header: headernuklear.}
proc input_any_mouse_click_in_rect*(a1: ptr input; a2: rect): cint {.cdecl,
...
proc input_is_mouse_click_in_rect*(a1: ptr input; a2: buttons; a3: rect): cint {.cdecl,
    importc: "nk_input_is_mouse_click_in_rect", header: headernuklear.}
proc input_has_mouse_click_down_in_rect*(a1: ptr input; a2: buttons; a3: rect;
                                        down: cint): cint {.cdecl,
    importc: "nk_input_has_mouse_click_down_in_rect", header: headernuklear.}
proc input_has_mouse_click_in_rect*(a1: ptr input; a2: buttons; a3: rect): cint {.cdecl,
    importc: "nk_input_has_mouse_click_in_rect", header: headernuklear.}
proc input_has_mouse_click*(a1: ptr input; a2: buttons): cint {.cdecl,
    importc: "nk_input_has_mouse_click", header: headernuklear.}
proc push_custom*(a1: ptr command_buffer; a2: rect; a3: command_custom_callback;
                 usr: handle) {.cdecl, importc: "nk_push_custom",
                              header: headernuklear.}
proc push_scissor*(a1: ptr command_buffer; a2: rect) {.cdecl,
    importc: "nk_push_scissor", header: headernuklear.}
proc draw_text*(a1: ptr command_buffer; a2: rect; text: cstring; len: cint;
               a5: ptr user_font; a6: color; a7: color) {.cdecl,
    importc: "nk_draw_text", header: headernuklear.}
proc draw_image*(a1: ptr command_buffer; a2: rect; a3: ptr img; a4: color) {.cdecl,
    importc: "nk_draw_image", header: headernuklear.}
proc fill_polygon*(a1: ptr command_buffer; a2: ptr cfloat; point_count: cint; a4: color) {.
    cdecl, importc: "nk_fill_polygon", header: headernuklear.}
proc fill_triangle*(a1: ptr command_buffer; x0: cfloat; y0: cfloat; x1: cfloat;
                   y1: cfloat; x2: cfloat; y2: cfloat; a8: color) {.cdecl,
    importc: "nk_fill_triangle", header: headernuklear.}
proc fill_arc*(a1: ptr command_buffer; cx: cfloat; cy: cfloat; radius: cfloat;
              a_min: cfloat; a_max: cfloat; a7: color) {.cdecl, importc: "nk_fill_arc",
    header: headernuklear.}
proc fill_circle*(a1: ptr command_buffer; a2: rect; a3: color) {.cdecl,
    importc: "nk_fill_circle", header: headernuklear.}
proc fill_rect_multi_color*(a1: ptr command_buffer; a2: rect; left: color; top: color;
                           right: color; bottom: color) {.cdecl,
    importc: "nk_fill_rect_multi_color", header: headernuklear.}
proc fill_rect*(a1: ptr command_buffer; a2: rect; rounding: cfloat; a4: color) {.cdecl,
    importc: "nk_fill_rect", header: headernuklear.}
proc stroke_polygon*(a1: ptr command_buffer; a2: ptr cfloat; point_count: cint;
                    line_thickness: cfloat; a5: color) {.cdecl,
    importc: "nk_stroke_polygon", header: headernuklear.}
proc stroke_polyline*(a1: ptr command_buffer; points: ptr cfloat; point_count: cint;
                     line_thickness: cfloat; col: color) {.cdecl,
    importc: "nk_stroke_polyline", header: headernuklear.}
proc stroke_triangle*(a1: ptr command_buffer; a2: cfloat; a3: cfloat; a4: cfloat;
                     a5: cfloat; a6: cfloat; a7: cfloat; line_thichness: cfloat;
                     a9: color) {.cdecl, importc: "nk_stroke_triangle",
                                header: headernuklear.}
proc stroke_arc*(a1: ptr command_buffer; cx: cfloat; cy: cfloat; radius: cfloat;
                a_min: cfloat; a_max: cfloat; line_thickness: cfloat; a8: color) {.
    cdecl, importc: "nk_stroke_arc", header: headernuklear.}
proc stroke_circle*(a1: ptr command_buffer; a2: rect; line_thickness: cfloat; a4: color) {.
    cdecl, importc: "nk_stroke_circle", header: headernuklear.}
proc stroke_rect*(a1: ptr command_buffer; a2: rect; rounding: cfloat;
                 line_thickness: cfloat; a5: color) {.cdecl,
    importc: "nk_stroke_rect", header: headernuklear.}
proc stroke_curve*(a1: ptr command_buffer; a2: cfloat; a3: cfloat; a4: cfloat; a5: cfloat;
                  a6: cfloat; a7: cfloat; a8: cfloat; a9: cfloat;
                  line_thickness: cfloat; a11: color) {.cdecl,
...
proc stroke_line*(b: ptr command_buffer; x0: cfloat; y0: cfloat; x1: cfloat; y1: cfloat;
                 line_thickness: cfloat; a7: color) {.cdecl,
    importc: "nk_stroke_line", header: headernuklear.}
proc textedit_redo*(a1: ptr text_edit) {.cdecl, importc: "nk_textedit_redo",
                                     header: headernuklear.}
proc textedit_undo*(a1: ptr text_edit) {.cdecl, importc: "nk_textedit_undo",
                                     header: headernuklear.}
proc textedit_paste*(a1: ptr text_edit; a2: cstring; len: cint): cint {.cdecl,
    importc: "nk_textedit_paste", header: headernuklear.}
proc textedit_cut*(a1: ptr text_edit): cint {.cdecl, importc: "nk_textedit_cut",
    header: headernuklear.}
proc textedit_select_all*(a1: ptr text_edit) {.cdecl,
    importc: "nk_textedit_select_all", header: headernuklear.}
proc textedit_delete_selection*(a1: ptr text_edit) {.cdecl,
    importc: "nk_textedit_delete_selection", header: headernuklear.}
proc textedit_delete*(a1: ptr text_edit; where: cint; len: cint) {.cdecl,
    importc: "nk_textedit_delete", header: headernuklear.}
proc textedit_text*(a1: ptr text_edit; a2: cstring; total_len: cint) {.cdecl,
    importc: "nk_textedit_text", header: headernuklear.}
proc textedit_free*(a1: ptr text_edit) {.cdecl, importc: "nk_textedit_free",
                                     header: headernuklear.}
proc textedit_init_fixed*(a1: ptr text_edit; memory: pointer; size: size) {.cdecl,
    importc: "nk_textedit_init_fixed", header: headernuklear.}
proc textedit_init*(a1: ptr text_edit; a2: ptr allocator; size: size) {.cdecl,
    importc: "nk_textedit_init", header: headernuklear.}
proc textedit_init_default*(a1: ptr text_edit) {.cdecl,
    importc: "nk_textedit_init_default", header: headernuklear.}
proc filter_binary*(a1: ptr text_edit; unicode: rune): cint {.cdecl,
    importc: "nk_filter_binary", header: headernuklear.}
proc filter_oct*(a1: ptr text_edit; unicode: rune): cint {.cdecl,
    importc: "nk_filter_oct", header: headernuklear.}
proc filter_hex*(a1: ptr text_edit; unicode: rune): cint {.cdecl,
    importc: "nk_filter_hex", header: headernuklear.}
proc filter_decimal*(a1: ptr text_edit; unicode: rune): cint {.cdecl,
    importc: "nk_filter_decimal", header: headernuklear.}
proc filter_float*(a1: ptr text_edit; unicode: rune): cint {.cdecl,
    importc: "nk_filter_float", header: headernuklear.}
proc filter_ascii*(a1: ptr text_edit; unicode: rune): cint {.cdecl,
    importc: "nk_filter_ascii", header: headernuklear.}
proc filter_default*(a1: ptr text_edit; unicode: rune): cint {.cdecl,
    importc: "nk_filter_default", header: headernuklear.}
proc str_len_char*(a1: ptr str): cint {.cdecl, importc: "nk_str_len_char",
                                   header: headernuklear.}
proc str_len*(a1: ptr str): cint {.cdecl, importc: "nk_str_len", header: headernuklear.}
proc str_get_const*(a1: ptr str): cstring {.cdecl, importc: "nk_str_get_const",
                                       header: headernuklear.}
proc str_get*(a1: ptr str): cstring {.cdecl, importc: "nk_str_get",
                                 header: headernuklear.}
proc str_at_const*(a1: ptr str; pos: cint; unicode: ptr rune; len: ptr cint): cstring {.
    cdecl, importc: "nk_str_at_const", header: headernuklear.}
proc str_at_char_const*(a1: ptr str; pos: cint): cstring {.cdecl,
    importc: "nk_str_at_char_const", header: headernuklear.}
proc str_rune_at*(a1: ptr str; pos: cint): rune {.cdecl, importc: "nk_str_rune_at",
    header: headernuklear.}
proc str_at_rune*(a1: ptr str; pos: cint; unicode: ptr rune; len: ptr cint): cstring {.cdecl,
    importc: "nk_str_at_rune", header: headernuklear.}
proc str_at_char*(a1: ptr str; pos: cint): cstring {.cdecl, importc: "nk_str_at_char",
    header: headernuklear.}
proc str_delete_runes*(a1: ptr str; pos: cint; len: cint) {.cdecl,
    importc: "nk_str_delete_runes", header: headernuklear.}
proc str_delete_chars*(a1: ptr str; pos: cint; len: cint) {.cdecl,
...
proc str_remove_chars*(a1: ptr str; len: cint) {.cdecl, importc: "nk_str_remove_chars",
    header: headernuklear.}
proc str_insert_str_runes*(a1: ptr str; pos: cint; a3: ptr rune): cint {.cdecl,
    importc: "nk_str_insert_str_runes", header: headernuklear.}
proc str_insert_text_runes*(a1: ptr str; pos: cint; a3: ptr rune; a4: cint): cint {.cdecl,
    importc: "nk_str_insert_text_runes", header: headernuklear.}
proc str_insert_str_utf8*(a1: ptr str; pos: cint; a3: cstring): cint {.cdecl,
    importc: "nk_str_insert_str_utf8", header: headernuklear.}
proc str_insert_text_utf8*(a1: ptr str; pos: cint; a3: cstring; a4: cint): cint {.cdecl,
    importc: "nk_str_insert_text_utf8", header: headernuklear.}
proc str_insert_str_char*(a1: ptr str; pos: cint; a3: cstring): cint {.cdecl,
    importc: "nk_str_insert_str_char", header: headernuklear.}
proc str_insert_text_char*(a1: ptr str; pos: cint; a3: cstring; a4: cint): cint {.cdecl,
    importc: "nk_str_insert_text_char", header: headernuklear.}
proc str_insert_at_rune*(a1: ptr str; pos: cint; a3: cstring; a4: cint): cint {.cdecl,
    importc: "nk_str_insert_at_rune", header: headernuklear.}
proc str_insert_at_char*(a1: ptr str; pos: cint; a3: cstring; a4: cint): cint {.cdecl,
    importc: "nk_str_insert_at_char", header: headernuklear.}
proc str_append_str_runes*(a1: ptr str; a2: ptr rune): cint {.cdecl,
    importc: "nk_str_append_str_runes", header: headernuklear.}
proc str_append_text_runes*(a1: ptr str; a2: ptr rune; a3: cint): cint {.cdecl,
    importc: "nk_str_append_text_runes", header: headernuklear.}
proc str_append_str_utf8*(a1: ptr str; a2: cstring): cint {.cdecl,
    importc: "nk_str_append_str_utf8", header: headernuklear.}
proc str_append_text_utf8*(a1: ptr str; a2: cstring; a3: cint): cint {.cdecl,
    importc: "nk_str_append_text_utf8", header: headernuklear.}
proc str_append_str_char*(a1: ptr str; a2: cstring): cint {.cdecl,
    importc: "nk_str_append_str_char", header: headernuklear.}
proc str_append_text_char*(a1: ptr str; a2: cstring; a3: cint): cint {.cdecl,
    importc: "nk_str_append_text_char", header: headernuklear.}
proc str_free*(a1: ptr str) {.cdecl, importc: "nk_str_free", header: headernuklear.}
proc str_clear*(a1: ptr str) {.cdecl, importc: "nk_str_clear", header: headernuklear.}
proc str_init_fixed*(a1: ptr str; memory: pointer; size: size) {.cdecl,
    importc: "nk_str_init_fixed", header: headernuklear.}
proc str_init*(a1: ptr str; a2: ptr allocator; size: size) {.cdecl,
    importc: "nk_str_init", header: headernuklear.}
proc str_init_default*(a1: ptr str) {.cdecl, importc: "nk_str_init_default",
                                  header: headernuklear.}
proc buffer_total*(a1: ptr buffer): size {.cdecl, importc: "nk_buffer_total",
                                      header: headernuklear.}
proc buffer_memory_const*(a1: ptr buffer): pointer {.cdecl,
    importc: "nk_buffer_memory_const", header: headernuklear.}
proc buffer_memory*(a1: ptr buffer): pointer {.cdecl, importc: "nk_buffer_memory",
    header: headernuklear.}
proc buffer_free*(a1: ptr buffer) {.cdecl, importc: "nk_buffer_free",
                                header: headernuklear.}
proc buffer_clear*(a1: ptr buffer) {.cdecl, importc: "nk_buffer_clear",
                                 header: headernuklear.}
proc buffer_reset*(a1: ptr buffer; `type`: buffer_allocation_type) {.cdecl,
    importc: "nk_buffer_reset", header: headernuklear.}
proc buffer_mark*(a1: ptr buffer; `type`: buffer_allocation_type) {.cdecl,
    importc: "nk_buffer_mark", header: headernuklear.}
proc buffer_push*(a1: ptr buffer; `type`: buffer_allocation_type; memory: pointer;
                 size: size; align: size) {.cdecl, importc: "nk_buffer_push",
                                        header: headernuklear.}
proc buffer_info*(a1: ptr memory_status; a2: ptr buffer) {.cdecl,
    importc: "nk_buffer_info", header: headernuklear.}
proc buffer_init_fixed*(a1: ptr buffer; memory: pointer; size: size) {.cdecl,
    importc: "nk_buffer_init_fixed", header: headernuklear.}
proc buffer_init*(a1: ptr buffer; a2: ptr allocator; size: size) {.cdecl,
    importc: "nk_buffer_init", header: headernuklear.}
proc buffer_init_default*(a1: ptr buffer) {.cdecl, importc: "nk_buffer_init_default",
                                        header: headernuklear.}
proc font_atlas_clear*(a1: ptr font_atlas) {.cdecl, importc: "nk_font_atlas_clear",
    header: headernuklear.}
proc font_atlas_cleanup*(atlas: ptr font_atlas) {.cdecl,
    importc: "nk_font_atlas_cleanup", header: headernuklear.}
proc font_find_glyph*(a1: ptr font; unicode: rune): ptr font_glyph {.cdecl,
    importc: "nk_font_find_glyph", header: headernuklear.}
proc font_atlas_end*(a1: ptr font_atlas; tex: handle; a3: ptr draw_null_texture) {.cdecl,
    importc: "nk_font_atlas_end", header: headernuklear.}
proc font_atlas_bake*(a1: ptr font_atlas; width: ptr cint; height: ptr cint;
                     a4: font_atlas_format): pointer {.cdecl,
    importc: "nk_font_atlas_bake", header: headernuklear.}
proc font_atlas_add_compressed_base85*(a1: ptr font_atlas; data: cstring;
                                      height: cfloat; config: ptr font_config): ptr font {.
    cdecl, importc: "nk_font_atlas_add_compressed_base85", header: headernuklear.}
proc font_atlas_add_compressed*(a1: ptr font_atlas; memory: pointer; size: size;
...
proc font_atlas_add_from_file*(atlas: ptr font_atlas; file_path: cstring;
                              height: cfloat; a4: ptr font_config): ptr font {.cdecl,
...
proc font_atlas_add_default*(a1: ptr font_atlas; height: cfloat; a3: ptr font_config): ptr font {.
    cdecl, importc: "nk_font_atlas_add_default", header: headernuklear.}
proc font_atlas_add*(a1: ptr font_atlas; a2: ptr font_config): ptr font {.cdecl,
...
proc font_atlas_begin*(a1: ptr font_atlas) {.cdecl, importc: "nk_font_atlas_begin",
    header: headernuklear.}
proc font_atlas_init_custom*(a1: ptr font_atlas; persistent: ptr allocator;
                            transient: ptr allocator) {.cdecl,
    importc: "nk_font_atlas_init_custom", header: headernuklear.}
proc font_atlas_init*(a1: ptr font_atlas; a2: ptr allocator) {.cdecl,
    importc: "nk_font_atlas_init", header: headernuklear.}
proc font_atlas_init_default*(a1: ptr font_atlas) {.cdecl,
...
proc utf_len*(a1: cstring; byte_len: cint): cint {.cdecl, importc: "nk_utf_len",
    header: headernuklear.}
proc utf_encode*(a1: rune; a2: cstring; a3: cint): cint {.cdecl,
    importc: "nk_utf_encode", header: headernuklear.}
proc utf_decode*(a1: cstring; a2: ptr rune; a3: cint): cint {.cdecl,
...
proc rect_size*(a1: rect): vec2 {.cdecl, importc: "nk_rect_size", header: headernuklear.}
proc rect_pos*(a1: rect): vec2 {.cdecl, importc: "nk_rect_pos", header: headernuklear.}
...
proc subimage_handle*(a1: handle; w: cushort; h: cushort; sub_region: rect): img {.
    cdecl, importc: "nk_subimage_handle", header: headernuklear.}
proc subimage_id*(a1: cint; w: cushort; h: cushort; sub_region: rect): img {.cdecl,
    importc: "nk_subimage_id", header: headernuklear.}
proc subimage_ptr*(a1: pointer; w: cushort; h: cushort; sub_region: rect): img {.cdecl,
...
proc image_id*(a1: cint): img {.cdecl, importc: "nk_image_id", header: headernuklear.}
proc image_ptr*(a1: pointer): img {.cdecl, importc: "nk_image_ptr",
                                  header: headernuklear.}
proc image_handle*(a1: handle): img {.cdecl, importc: "nk_image_handle",
                                    header: headernuklear.}
proc handle_id*(a1: cint): handle {.cdecl, importc: "nk_handle_id",
                                header: headernuklear.}
proc handle_ptr*(a1: pointer): handle {.cdecl, importc: "nk_handle_ptr",
                                    header: headernuklear.}
proc color_hsva_fv*(hsva_out: ptr cfloat; a2: color) {.cdecl,
    importc: "nk_color_hsva_fv", header: headernuklear.}
proc color_hsva_f*(out_h: ptr cfloat; out_s: ptr cfloat; out_v: ptr cfloat;
                  out_a: ptr cfloat; a5: color) {.cdecl, importc: "nk_color_hsva_f",
    header: headernuklear.}
proc color_hsva_bv*(hsva_out: ptr byte; a2: color) {.cdecl,
    importc: "nk_color_hsva_bv", header: headernuklear.}
proc color_hsva_iv*(hsva_out: ptr cint; a2: color) {.cdecl,
    importc: "nk_color_hsva_iv", header: headernuklear.}
proc color_hsva_b*(h: ptr byte; s: ptr byte; v: ptr byte; a: ptr byte; a5: color) {.cdecl,
    importc: "nk_color_hsva_b", header: headernuklear.}
proc color_hsva_i*(h: ptr cint; s: ptr cint; v: ptr cint; a: ptr cint; a5: color) {.cdecl,
    importc: "nk_color_hsva_i", header: headernuklear.}
proc color_hsv_fv*(hsv_out: ptr cfloat; a2: color) {.cdecl, importc: "nk_color_hsv_fv",
    header: headernuklear.}
proc color_hsv_f*(out_h: ptr cfloat; out_s: ptr cfloat; out_v: ptr cfloat; a4: color) {.
    cdecl, importc: "nk_color_hsv_f", header: headernuklear.}
proc color_hsv_bv*(hsv_out: ptr byte; a2: color) {.cdecl, importc: "nk_color_hsv_bv",
    header: headernuklear.}
proc color_hsv_iv*(hsv_out: ptr cint; a2: color) {.cdecl, importc: "nk_color_hsv_iv",
    header: headernuklear.}
proc color_hsv_b*(out_h: ptr byte; out_s: ptr byte; out_v: ptr byte; a4: color) {.cdecl,
    importc: "nk_color_hsv_b", header: headernuklear.}
proc color_hsv_i*(out_h: ptr cint; out_s: ptr cint; out_v: ptr cint; a4: color) {.cdecl,
    importc: "nk_color_hsv_i", header: headernuklear.}
proc color_hex_rgb*(output: cstring; a2: color) {.cdecl, importc: "nk_color_hex_rgb",
    header: headernuklear.}
proc color_hex_rgba*(output: cstring; a2: color) {.cdecl,
    importc: "nk_color_hex_rgba", header: headernuklear.}
proc color_u32*(a1: color): uint {.cdecl, importc: "nk_color_u32",
                               header: headernuklear.}
proc color_dv*(rgba_out: ptr cdouble; a2: color) {.cdecl, importc: "nk_color_dv",
    header: headernuklear.}
proc color_d*(r: ptr cdouble; g: ptr cdouble; b: ptr cdouble; a: ptr cdouble; a5: color) {.
    cdecl, importc: "nk_color_d", header: headernuklear.}
proc color_cf*(a1: color): colorf {.cdecl, importc: "nk_color_cf",
                                header: headernuklear.}
proc color_fv*(rgba_out: ptr cfloat; a2: color) {.cdecl, importc: "nk_color_fv",
    header: headernuklear.}
proc nk_color_f*(r: ptr cfloat; g: ptr cfloat; b: ptr cfloat; a: ptr cfloat; a5: color) {.cdecl,
...
proc rgba_iv*(rgba: ptr cint): color {.cdecl, importc: "nk_rgba_iv",
                                  header: headernuklear.}
proc rgba_u32*(a1: uint): color {.cdecl, importc: "nk_rgba_u32", header: headernuklear.}
...
proc rgb*(r: cint; g: cint; b: cint): color {.cdecl, importc: "nk_rgb",
                                      header: headernuklear.}
proc style_pop_color*(a1: ptr context): cint {.cdecl, importc: "nk_style_pop_color",
    header: headernuklear.}
proc style_pop_flags*(a1: ptr context): cint {.cdecl, importc: "nk_style_pop_flags",
    header: headernuklear.}
proc style_pop_style_item*(a1: ptr context): cint {.cdecl,
    importc: "nk_style_pop_style_item", header: headernuklear.}
proc style_pop_vec2*(a1: ptr context): cint {.cdecl, importc: "nk_style_pop_vec2",
    header: headernuklear.}
proc style_pop_float*(a1: ptr context): cint {.cdecl, importc: "nk_style_pop_float",
    header: headernuklear.}
proc style_pop_font*(a1: ptr context): cint {.cdecl, importc: "nk_style_pop_font",
    header: headernuklear.}
proc style_push_color*(a1: ptr context; a2: ptr color; a3: color): cint {.cdecl,
    importc: "nk_style_push_color", header: headernuklear.}
proc style_push_flags*(a1: ptr context; a2: ptr flags; a3: flags): cint {.cdecl,
    importc: "nk_style_push_flags", header: headernuklear.}
proc style_push_style_item*(a1: ptr context; a2: ptr style_item; a3: style_item): cint {.
    cdecl, importc: "nk_style_push_style_item", header: headernuklear.}
proc style_push_vec2*(a1: ptr context; a2: ptr vec2; a3: vec2): cint {.cdecl,
    importc: "nk_style_push_vec2", header: headernuklear.}
proc style_push_float*(a1: ptr context; a2: ptr cfloat; a3: cfloat): cint {.cdecl,
    importc: "nk_style_push_float", header: headernuklear.}
proc style_push_font*(a1: ptr context; a2: ptr user_font): cint {.cdecl,
    importc: "nk_style_push_font", header: headernuklear.}
proc style_hide_cursor*(a1: ptr context) {.cdecl, importc: "nk_style_hide_cursor",
                                       header: headernuklear.}
proc style_show_cursor*(a1: ptr context) {.cdecl, importc: "nk_style_show_cursor",
                                       header: headernuklear.}
proc style_set_cursor*(a1: ptr context; a2: style_cursor): cint {.cdecl,
    importc: "nk_style_set_cursor", header: headernuklear.}
proc style_set_font*(a1: ptr context; a2: ptr user_font) {.cdecl,
    importc: "nk_style_set_font", header: headernuklear.}
proc style_get_color_by_name*(a1: style_colors): cstring {.cdecl,
    importc: "nk_style_get_color_by_name", header: headernuklear.}
proc style_load_all_cursors*(a1: ptr context; a2: ptr cursor) {.cdecl,
    importc: "nk_style_load_all_cursors", header: headernuklear.}
proc style_load_cursor*(a1: ptr context; a2: style_cursor; a3: ptr cursor) {.cdecl,
    importc: "nk_style_load_cursor", header: headernuklear.}
proc style_from_table*(a1: ptr context; a2: ptr color) {.cdecl,
    importc: "nk_style_from_table", header: headernuklear.}
proc style_default*(a1: ptr context) {.cdecl, importc: "nk_style_default",
                                   header: headernuklear.}
proc menu_end*(a1: ptr context) {.cdecl, importc: "nk_menu_end", header: headernuklear.}
proc menu_close*(a1: ptr context) {.cdecl, importc: "nk_menu_close",
                                header: headernuklear.}
proc menu_item_symbol_label*(a1: ptr context; a2: symbol_type; a3: cstring;
                            alignment: flags): cint {.cdecl,
    importc: "nk_menu_item_symbol_label", header: headernuklear.}
proc menu_item_symbol_text*(a1: ptr context; a2: symbol_type; a3: cstring; a4: cint;
                           alignment: flags): cint {.cdecl,
    importc: "nk_menu_item_symbol_text", header: headernuklear.}
proc menu_item_image_text*(a1: ptr context; a2: img; a3: cstring; len: cint;
                          alignment: flags): cint {.cdecl,
    importc: "nk_menu_item_image_text", header: headernuklear.}
proc menu_item_image_label*(a1: ptr context; a2: img; a3: cstring; alignment: flags): cint {.
    cdecl, importc: "nk_menu_item_image_label", header: headernuklear.}
proc menu_item_label*(a1: ptr context; a2: cstring; alignment: flags): cint {.cdecl,
    importc: "nk_menu_item_label", header: headernuklear.}
proc menu_item_text*(a1: ptr context; a2: cstring; a3: cint; align: flags): cint {.cdecl,
    importc: "nk_menu_item_text", header: headernuklear.}
proc menu_begin_symbol_label*(a1: ptr context; a2: cstring; align: flags;
                             a4: symbol_type; size: vec2): cint {.cdecl,
    importc: "nk_menu_begin_symbol_label", header: headernuklear.}
proc menu_begin_symbol_text*(a1: ptr context; a2: cstring; a3: cint; align: flags;
                            a5: symbol_type; size: vec2): cint {.cdecl,
    importc: "nk_menu_begin_symbol_text", header: headernuklear.}
proc menu_begin_symbol*(a1: ptr context; a2: cstring; a3: symbol_type; size: vec2): cint {.
    cdecl, importc: "nk_menu_begin_symbol", header: headernuklear.}
proc menu_begin_image_label*(a1: ptr context; a2: cstring; align: flags; a4: img;
                            size: vec2): cint {.cdecl,
    importc: "nk_menu_begin_image_label", header: headernuklear.}
proc menu_begin_image_text*(a1: ptr context; a2: cstring; a3: cint; align: flags;
                           a5: img; size: vec2): cint {.cdecl,
    importc: "nk_menu_begin_image_text", header: headernuklear.}
proc menu_begin_image*(a1: ptr context; a2: cstring; a3: img; size: vec2): cint {.cdecl,
    importc: "nk_menu_begin_image", header: headernuklear.}
proc menu_begin_label*(a1: ptr context; a2: cstring; align: flags; size: vec2): cint {.
    cdecl, importc: "nk_menu_begin_label", header: headernuklear.}
proc menu_begin_text*(a1: ptr context; title: cstring; title_len: cint; align: flags;
                     size: vec2): cint {.cdecl, importc: "nk_menu_begin_text",
                                      header: headernuklear.}
proc menubar_end*(a1: ptr context) {.cdecl, importc: "nk_menubar_end",
                                 header: headernuklear.}
proc menubar_begin*(a1: ptr context) {.cdecl, importc: "nk_menubar_begin",
                                   header: headernuklear.}
proc tooltip_end*(a1: ptr context) {.cdecl, importc: "nk_tooltip_end",
                                 header: headernuklear.}
proc tooltip_begin*(a1: ptr context; width: cfloat): cint {.cdecl,
    importc: "nk_tooltip_begin", header: headernuklear.}
proc tooltip*(a1: ptr context; a2: cstring) {.cdecl, importc: "nk_tooltip",
                                        header: headernuklear.}
proc contextual_end*(a1: ptr context) {.cdecl, importc: "nk_contextual_end",
                                    header: headernuklear.}
proc contextual_close*(a1: ptr context) {.cdecl, importc: "nk_contextual_close",
                                      header: headernuklear.}
proc contextual_item_symbol_text*(a1: ptr context; a2: symbol_type; a3: cstring;
                                 a4: cint; alignment: flags): cint {.cdecl,
    importc: "nk_contextual_item_symbol_text", header: headernuklear.}
proc contextual_item_symbol_label*(a1: ptr context; a2: symbol_type; a3: cstring;
                                  alignment: flags): cint {.cdecl,
    importc: "nk_contextual_item_symbol_label", header: headernuklear.}
proc contextual_item_image_text*(a1: ptr context; a2: img; a3: cstring; len: cint;
                                alignment: flags): cint {.cdecl,
    importc: "nk_contextual_item_image_text", header: headernuklear.}
proc contextual_item_image_label*(a1: ptr context; a2: img; a3: cstring;
                                 alignment: flags): cint {.cdecl,
    importc: "nk_contextual_item_image_label", header: headernuklear.}
proc contextual_item_label*(a1: ptr context; a2: cstring; align: flags): cint {.cdecl,
    importc: "nk_contextual_item_label", header: headernuklear.}
proc contextual_item_text*(a1: ptr context; a2: cstring; a3: cint; align: flags): cint {.
    cdecl, importc: "nk_contextual_item_text", header: headernuklear.}
proc contextual_begin*(a1: ptr context; a2: flags; a3: vec2; trigger_bounds: rect): cint {.
    cdecl, importc: "nk_contextual_begin", header: headernuklear.}
proc combo_end*(a1: ptr context) {.cdecl, importc: "nk_combo_end",
                               header: headernuklear.}
proc combo_close*(a1: ptr context) {.cdecl, importc: "nk_combo_close",
                                 header: headernuklear.}
proc combo_item_symbol_text*(a1: ptr context; a2: symbol_type; a3: cstring; a4: cint;
                            alignment: flags): cint {.cdecl,
    importc: "nk_combo_item_symbol_text", header: headernuklear.}
proc combo_item_symbol_label*(a1: ptr context; a2: symbol_type; a3: cstring;
                             alignment: flags): cint {.cdecl,
    importc: "nk_combo_item_symbol_label", header: headernuklear.}
proc combo_item_image_text*(a1: ptr context; a2: img; a3: cstring; a4: cint;
                           alignment: flags): cint {.cdecl,
    importc: "nk_combo_item_image_text", header: headernuklear.}
proc combo_item_image_label*(a1: ptr context; a2: img; a3: cstring; alignment: flags): cint {.
    cdecl, importc: "nk_combo_item_image_label", header: headernuklear.}
proc combo_item_text*(a1: ptr context; a2: cstring; a3: cint; alignment: flags): cint {.
    cdecl, importc: "nk_combo_item_text", header: headernuklear.}
proc combo_item_label*(a1: ptr context; a2: cstring; alignment: flags): cint {.cdecl,
    importc: "nk_combo_item_label", header: headernuklear.}
proc combo_begin_image_text*(a1: ptr context; selected: cstring; a3: cint; a4: img;
                            size: vec2): cint {.cdecl,
    importc: "nk_combo_begin_image_text", header: headernuklear.}
proc combo_begin_image_label*(a1: ptr context; selected: cstring; a3: img; size: vec2): cint {.
    cdecl, importc: "nk_combo_begin_image_label", header: headernuklear.}
proc combo_begin_image*(a1: ptr context; img: img; size: vec2): cint {.cdecl,
    importc: "nk_combo_begin_image", header: headernuklear.}
proc combo_begin_symbol_text*(a1: ptr context; selected: cstring; a3: cint;
                             a4: symbol_type; size: vec2): cint {.cdecl,
    importc: "nk_combo_begin_symbol_text", header: headernuklear.}
proc combo_begin_symbol_label*(a1: ptr context; selected: cstring; a3: symbol_type;
                              size: vec2): cint {.cdecl,
    importc: "nk_combo_begin_symbol_label", header: headernuklear.}
proc combo_begin_symbol*(a1: ptr context; a2: symbol_type; size: vec2): cint {.cdecl,
    importc: "nk_combo_begin_symbol", header: headernuklear.}
proc combo_begin_color*(a1: ptr context; color: color; size: vec2): cint {.cdecl,
    importc: "nk_combo_begin_color", header: headernuklear.}
proc combo_begin_label*(a1: ptr context; selected: cstring; size: vec2): cint {.cdecl,
    importc: "nk_combo_begin_label", header: headernuklear.}
proc combo_begin_text*(a1: ptr context; selected: cstring; a3: cint; size: vec2): cint {.
    cdecl, importc: "nk_combo_begin_text", header: headernuklear.}
proc combobox_callback*(a1: ptr context; item_getter: proc (a1: pointer; a2: cint;
...
proc combobox_separator*(a1: ptr context; items_separated_by_separator: cstring;
                        separator: cint; selected: ptr cint; count: cint;
                        item_height: cint; size: vec2) {.cdecl,
    importc: "nk_combobox_separator", header: headernuklear.}
proc combobox_string*(a1: ptr context; items_separated_by_zeros: cstring;
                     selected: ptr cint; count: cint; item_height: cint; size: vec2) {.
    cdecl, importc: "nk_combobox_string", header: headernuklear.}
proc combobox*(a1: ptr context; items: cstringArray; count: cint; selected: ptr cint;
              item_height: cint; size: vec2) {.cdecl, importc: "nk_combobox",
    header: headernuklear.}
proc combo_callback*(a1: ptr context; item_getter: proc (a1: pointer; a2: cint;
...
proc combo_string*(a1: ptr context; items_separated_by_zeros: cstring; selected: cint;
                  count: cint; item_height: cint; size: vec2): cint {.cdecl,
    importc: "nk_combo_string", header: headernuklear.}
proc combo_separator*(a1: ptr context; items_separated_by_separator: cstring;
                     separator: cint; selected: cint; count: cint; item_height: cint;
                     size: vec2): cint {.cdecl, importc: "nk_combo_separator",
                                      header: headernuklear.}
proc combo*(a1: ptr context; items: cstringArray; count: cint; selected: cint;
           item_height: cint; size: vec2): cint {.cdecl, importc: "nk_combo",
    header: headernuklear.}
proc popup_end*(a1: ptr context) {.cdecl, importc: "nk_popup_end",
                               header: headernuklear.}
proc popup_close*(a1: ptr context) {.cdecl, importc: "nk_popup_close",
                                 header: headernuklear.}
proc popup_begin*(a1: ptr context; a2: popup_type; a3: cstring; a4: flags; bounds: rect): cint {.
    cdecl, importc: "nk_popup_begin", header: headernuklear.}
proc plot_function*(a1: ptr context; a2: chart_type; userdata: pointer; value_getter: proc (
    user: pointer; index: cint): cfloat {.cdecl.}; count: cint; offset: cint) {.cdecl,
    importc: "nk_plot_function", header: headernuklear.}
proc plot*(a1: ptr context; a2: chart_type; values: ptr cfloat; count: cint; offset: cint) {.
    cdecl, importc: "nk_plot", header: headernuklear.}
proc chart_end*(a1: ptr context) {.cdecl, importc: "nk_chart_end",
                               header: headernuklear.}
proc chart_push_slot*(a1: ptr context; a2: cfloat; a3: cint): flags {.cdecl,
    importc: "nk_chart_push_slot", header: headernuklear.}
proc chart_push*(a1: ptr context; a2: cfloat): flags {.cdecl, importc: "nk_chart_push",
    header: headernuklear.}
proc chart_add_slot_colored*(ctx: ptr context; a2: chart_type; a3: color; active: color;
                            count: cint; min_value: cfloat; max_value: cfloat) {.
    cdecl, importc: "nk_chart_add_slot_colored", header: headernuklear.}
proc chart_add_slot*(ctx: ptr context; a2: chart_type; count: cint; min_value: cfloat;
                    max_value: cfloat) {.cdecl, importc: "nk_chart_add_slot",
                                       header: headernuklear.}
proc chart_begin_colored*(a1: ptr context; a2: chart_type; a3: color; active: color;
                         num: cint; min: cfloat; max: cfloat): cint {.cdecl,
    importc: "nk_chart_begin_colored", header: headernuklear.}
proc chart_begin*(a1: ptr context; a2: chart_type; num: cint; min: cfloat; max: cfloat): cint {.
    cdecl, importc: "nk_chart_begin", header: headernuklear.}
proc edit_unfocus*(a1: ptr context) {.cdecl, importc: "nk_edit_unfocus",
                                  header: headernuklear.}
proc edit_focus*(a1: ptr context; flags: flags) {.cdecl, importc: "nk_edit_focus",
    header: headernuklear.}
proc edit_buffer*(a1: ptr context; a2: flags; a3: ptr text_edit; a4: plugin_filter): flags {.
    cdecl, importc: "nk_edit_buffer", header: headernuklear.}
proc edit_string_zero_terminated*(a1: ptr context; a2: flags; buffer: cstring;
                                 max: cint; a5: plugin_filter): flags {.cdecl,
    importc: "nk_edit_string_zero_terminated", header: headernuklear.}
proc edit_string*(a1: ptr context; a2: flags; buffer: cstring; len: ptr cint; max: cint;
                 a6: plugin_filter): flags {.cdecl, importc: "nk_edit_string",
    header: headernuklear.}
proc propertyd*(a1: ptr context; name: cstring; min: cdouble; val: cdouble; max: cdouble;
               step: cdouble; inc_per_pixel: cfloat): cdouble {.cdecl,
    importc: "nk_propertyd", header: headernuklear.}
proc propertyf*(a1: ptr context; name: cstring; min: cfloat; val: cfloat; max: cfloat;
               step: cfloat; inc_per_pixel: cfloat): cfloat {.cdecl,
    importc: "nk_propertyf", header: headernuklear.}
proc propertyi*(a1: ptr context; name: cstring; min: cint; val: cint; max: cint; step: cint;
               inc_per_pixel: cfloat): cint {.cdecl, importc: "nk_propertyi",
    header: headernuklear.}
proc property_double*(a1: ptr context; name: cstring; min: cdouble; val: ptr cdouble;
                     max: cdouble; step: cdouble; inc_per_pixel: cfloat) {.cdecl,
    importc: "nk_property_double", header: headernuklear.}
proc property_float*(a1: ptr context; name: cstring; min: cfloat; val: ptr cfloat;
                    max: cfloat; step: cfloat; inc_per_pixel: cfloat) {.cdecl,
    importc: "nk_property_float", header: headernuklear.}
proc property_int*(a1: ptr context; name: cstring; min: cint; val: ptr cint; max: cint;
                  step: cint; inc_per_pixel: cfloat) {.cdecl,
    importc: "nk_property_int", header: headernuklear.}
proc color_pick*(a1: ptr context; a2: ptr colorf; a3: color_format): cint {.cdecl,
    importc: "nk_color_pick", header: headernuklear.}
proc color_picker*(a1: ptr context; a2: colorf; a3: color_format): colorf {.cdecl,
    importc: "nk_color_picker", header: headernuklear.}
proc prog*(a1: ptr context; cur: size; max: size; modifyable: cint): size {.cdecl,
    importc: "nk_prog", header: headernuklear.}
proc progress*(a1: ptr context; cur: ptr size; max: size; modifyable: cint): cint {.cdecl,
    importc: "nk_progress", header: headernuklear.}
proc slider_int*(a1: ptr context; min: cint; val: ptr cint; max: cint; step: cint): cint {.
    cdecl, importc: "nk_slider_int", header: headernuklear.}
proc slider_float*(a1: ptr context; min: cfloat; val: ptr cfloat; max: cfloat; step: cfloat): cint {.
    cdecl, importc: "nk_slider_float", header: headernuklear.}
proc slide_int*(a1: ptr context; min: cint; val: cint; max: cint; step: cint): cint {.cdecl,
    importc: "nk_slide_int", header: headernuklear.}
proc slide_float*(a1: ptr context; min: cfloat; val: cfloat; max: cfloat; step: cfloat): cfloat {.
    cdecl, importc: "nk_slide_float", header: headernuklear.}
proc select_symbol_text*(a1: ptr context; a2: symbol_type; a3: cstring; a4: cint;
                        align: flags; value: cint): cint {.cdecl,
    importc: "nk_select_symbol_text", header: headernuklear.}
proc select_symbol_label*(a1: ptr context; a2: symbol_type; a3: cstring; align: flags;
                         value: cint): cint {.cdecl,
    importc: "nk_select_symbol_label", header: headernuklear.}
proc select_image_text*(a1: ptr context; a2: img; a3: cstring; a4: cint; align: flags;
                       value: cint): cint {.cdecl, importc: "nk_select_image_text",
    header: headernuklear.}
proc select_image_label*(a1: ptr context; a2: img; a3: cstring; align: flags;
                        value: cint): cint {.cdecl,
    importc: "nk_select_image_label", header: headernuklear.}
proc select_text*(a1: ptr context; a2: cstring; a3: cint; align: flags; value: cint): cint {.
    cdecl, importc: "nk_select_text", header: headernuklear.}
proc select_label*(a1: ptr context; a2: cstring; align: flags; value: cint): cint {.cdecl,
    importc: "nk_select_label", header: headernuklear.}
proc selectable_symbol_text*(a1: ptr context; a2: symbol_type; a3: cstring; a4: cint;
                            align: flags; value: ptr cint): cint {.cdecl,
    importc: "nk_selectable_symbol_text", header: headernuklear.}
proc selectable_symbol_label*(a1: ptr context; a2: symbol_type; a3: cstring;
                             align: flags; value: ptr cint): cint {.cdecl,
    importc: "nk_selectable_symbol_label", header: headernuklear.}
proc selectable_image_text*(a1: ptr context; a2: img; a3: cstring; a4: cint;
                           align: flags; value: ptr cint): cint {.cdecl,
    importc: "nk_selectable_image_text", header: headernuklear.}
proc selectable_image_label*(a1: ptr context; a2: img; a3: cstring; align: flags;
                            value: ptr cint): cint {.cdecl,
    importc: "nk_selectable_image_label", header: headernuklear.}
proc selectable_text*(a1: ptr context; a2: cstring; a3: cint; align: flags;
                     value: ptr cint): cint {.cdecl, importc: "nk_selectable_text",
    header: headernuklear.}
proc selectable_label*(a1: ptr context; a2: cstring; align: flags; value: ptr cint): cint {.
    cdecl, importc: "nk_selectable_label", header: headernuklear.}
proc option_text*(a1: ptr context; a2: cstring; a3: cint; active: cint): cint {.cdecl,
    importc: "nk_option_text", header: headernuklear.}
proc option_label*(a1: ptr context; a2: cstring; active: cint): cint {.cdecl,
    importc: "nk_option_label", header: headernuklear.}
proc radio_text*(a1: ptr context; a2: cstring; a3: cint; active: ptr cint): cint {.cdecl,
    importc: "nk_radio_text", header: headernuklear.}
proc radio_label*(a1: ptr context; a2: cstring; active: ptr cint): cint {.cdecl,
    importc: "nk_radio_label", header: headernuklear.}
proc checkbox_flags_text*(a1: ptr context; a2: cstring; a3: cint; flags: ptr cuint;
                         value: cuint): cint {.cdecl,
    importc: "nk_checkbox_flags_text", header: headernuklear.}
proc checkbox_flags_label*(a1: ptr context; a2: cstring; flags: ptr cuint; value: cuint): cint {.
    cdecl, importc: "nk_checkbox_flags_label", header: headernuklear.}
proc checkbox_text*(a1: ptr context; a2: cstring; a3: cint; active: ptr cint): cint {.cdecl,
    importc: "nk_checkbox_text", header: headernuklear.}
proc checkbox_label*(a1: ptr context; a2: cstring; active: ptr cint): cint {.cdecl,
    importc: "nk_checkbox_label", header: headernuklear.}
proc check_flags_text*(a1: ptr context; a2: cstring; a3: cint; flags: cuint; value: cuint): cuint {.
    cdecl, importc: "nk_check_flags_text", header: headernuklear.}
proc check_flags_label*(a1: ptr context; a2: cstring; flags: cuint; value: cuint): cuint {.
    cdecl, importc: "nk_check_flags_label", header: headernuklear.}
proc check_text*(a1: ptr context; a2: cstring; a3: cint; active: cint): cint {.cdecl,
    importc: "nk_check_text", header: headernuklear.}
proc check_label*(a1: ptr context; a2: cstring; active: cint): cint {.cdecl,
    importc: "nk_check_label", header: headernuklear.}
proc button_pop_behavior*(a1: ptr context): cint {.cdecl,
    importc: "nk_button_pop_behavior", header: headernuklear.}
proc button_push_behavior*(a1: ptr context; a2: button_behavior): cint {.cdecl,
    importc: "nk_button_push_behavior", header: headernuklear.}
proc button_set_behavior*(a1: ptr context; a2: button_behavior) {.cdecl,
    importc: "nk_button_set_behavior", header: headernuklear.}
proc button_image_text_styled*(a1: ptr context; a2: ptr style_button; img: img;
                              a4: cstring; a5: cint; alignment: flags): cint {.cdecl,
    importc: "nk_button_image_text_styled", header: headernuklear.}
proc button_image_label_styled*(a1: ptr context; a2: ptr style_button; img: img;
                               a4: cstring; text_alignment: flags): cint {.cdecl,
...
proc button_symbol_text_styled*(a1: ptr context; a2: ptr style_button; a3: symbol_type;
                               a4: cstring; a5: cint; alignment: flags): cint {.cdecl,
    importc: "nk_button_symbol_text_styled", header: headernuklear.}
proc button_image_styled*(a1: ptr context; a2: ptr style_button; img: img): cint {.
    cdecl, importc: "nk_button_image_styled", header: headernuklear.}
proc button_symbol_styled*(a1: ptr context; a2: ptr style_button; a3: symbol_type): cint {.
    cdecl, importc: "nk_button_symbol_styled", header: headernuklear.}
proc button_label_styled*(a1: ptr context; a2: ptr style_button; title: cstring): cint {.
    cdecl, importc: "nk_button_label_styled", header: headernuklear.}
proc button_text_styled*(a1: ptr context; a2: ptr style_button; title: cstring; len: cint): cint {.
    cdecl, importc: "nk_button_text_styled", header: headernuklear.}
proc button_image_text*(a1: ptr context; img: img; a3: cstring; a4: cint;
                       alignment: flags): cint {.cdecl,
    importc: "nk_button_image_text", header: headernuklear.}
proc button_image_label*(a1: ptr context; img: img; a3: cstring; text_alignment: flags): cint {.
    cdecl, importc: "nk_button_image_label", header: headernuklear.}
proc button_symbol_text*(a1: ptr context; a2: symbol_type; a3: cstring; a4: cint;
                        alignment: flags): cint {.cdecl,
    importc: "nk_button_symbol_text", header: headernuklear.}
proc button_symbol_label*(a1: ptr context; a2: symbol_type; a3: cstring;
                         text_alignment: flags): cint {.cdecl,
    importc: "nk_button_symbol_label", header: headernuklear.}
proc button_image*(a1: ptr context; img: img): cint {.cdecl,
    importc: "nk_button_image", header: headernuklear.}
proc button_symbol*(a1: ptr context; a2: symbol_type): cint {.cdecl,
    importc: "nk_button_symbol", header: headernuklear.}
proc button_color*(a1: ptr context; a2: color): cint {.cdecl,
    importc: "nk_button_color", header: headernuklear.}
proc button_label*(a1: ptr context; title: cstring): cint {.cdecl,
    importc: "nk_button_label", header: headernuklear.}
proc button_text*(a1: ptr context; title: cstring; len: cint): cint {.cdecl,
    importc: "nk_button_text", header: headernuklear.}
proc image_color*(a1: ptr context; a2: img; a3: color) {.cdecl,
    importc: "nk_image_color", header: headernuklear.}
proc image*(a1: ptr context; a2: img) {.cdecl, importc: "struct nk_image",
                                    header: headernuklear.}
proc label_colored_wrap*(a1: ptr context; a2: cstring; a3: color) {.cdecl,
    importc: "nk_label_colored_wrap", header: headernuklear.}
proc label_wrap*(a1: ptr context; a2: cstring) {.cdecl, importc: "nk_label_wrap",
    header: headernuklear.}
proc label_colored*(a1: ptr context; a2: cstring; align: flags; a4: color) {.cdecl,
    importc: "nk_label_colored", header: headernuklear.}
proc label*(a1: ptr context; a2: cstring; align: flags) {.cdecl, importc: "nk_label",
    header: headernuklear.}
proc text_wrap_colored*(a1: ptr context; a2: cstring; a3: cint; a4: color) {.cdecl,
    importc: "nk_text_wrap_colored", header: headernuklear.}
proc text_wrap*(a1: ptr context; a2: cstring; a3: cint) {.cdecl, importc: "nk_text_wrap",
    header: headernuklear.}
proc text_colored*(a1: ptr context; a2: cstring; a3: cint; a4: flags; a5: color) {.cdecl,
    importc: "nk_text_colored", header: headernuklear.}
proc text*(a1: ptr context; a2: cstring; a3: cint; a4: flags) {.cdecl, importc: "nk_text",
    header: headernuklear.}
proc spacing*(a1: ptr context; cols: cint) {.cdecl, importc: "nk_spacing",
                                       header: headernuklear.}
proc widget_has_mouse_click_down*(a1: ptr context; a2: buttons; down: cint): cint {.
    cdecl, importc: "nk_widget_has_mouse_click_down", header: headernuklear.}
proc widget_is_mouse_clicked*(a1: ptr context; a2: buttons): cint {.cdecl,
    importc: "nk_widget_is_mouse_clicked", header: headernuklear.}
proc widget_is_hovered*(a1: ptr context): cint {.cdecl,
    importc: "nk_widget_is_hovered", header: headernuklear.}
proc widget_height*(a1: ptr context): cfloat {.cdecl, importc: "nk_widget_height",
    header: headernuklear.}
proc widget_width*(a1: ptr context): cfloat {.cdecl, importc: "nk_widget_width",
    header: headernuklear.}
proc widget_size*(a1: ptr context): vec2 {.cdecl, importc: "nk_widget_size",
                                      header: headernuklear.}
proc widget_position*(a1: ptr context): vec2 {.cdecl, importc: "nk_widget_position",
    header: headernuklear.}
proc widget_bounds*(a1: ptr context): rect {.cdecl, importc: "nk_widget_bounds",
                                        header: headernuklear.}
proc widget_fitting*(a1: ptr rect; a2: ptr context; a3: vec2): widget_layout_states {.
    cdecl, importc: "nk_widget_fitting", header: headernuklear.}
proc widget*(a1: ptr rect; a2: ptr context): widget_layout_states {.cdecl,
    importc: "nk_widget", header: headernuklear.}
proc list_view_end*(a1: ptr list_view) {.cdecl, importc: "nk_list_view_end",
                                     header: headernuklear.}
proc list_view_begin*(a1: ptr context; `out`: ptr list_view; id: cstring; a4: flags;
                     row_height: cint; row_count: cint): cint {.cdecl,
    importc: "nk_list_view_begin", header: headernuklear.}
proc tree_element_pop*(a1: ptr context) {.cdecl, importc: "nk_tree_element_pop",
                                      header: headernuklear.}
proc tree_element_image_push_hashed*(a1: ptr context; a2: tree_type; a3: img;
                                    title: cstring;
...
proc tree_element_push_hashed*(a1: ptr context; a2: tree_type; title: cstring;
...
proc tree_state_pop*(a1: ptr context) {.cdecl, importc: "nk_tree_state_pop",
                                    header: headernuklear.}
proc tree_state_image_push*(a1: ptr context; a2: tree_type; a3: img; title: cstring;
                           state: ptr collapse_states): cint {.cdecl,
    importc: "nk_tree_state_image_push", header: headernuklear.}
proc tree_state_push*(a1: ptr context; a2: tree_type; title: cstring;
                     state: ptr collapse_states): cint {.cdecl,
    importc: "nk_tree_state_push", header: headernuklear.}
proc tree_pop*(a1: ptr context) {.cdecl, importc: "nk_tree_pop", header: headernuklear.}
proc tree_image_push_hashed*(a1: ptr context; a2: tree_type; a3: img; title: cstring;
...
proc tree_push_hashed*(a1: ptr context; a2: tree_type; title: cstring;
                      initial_state: collapse_states; hash: cstring; len: cint;
                      seed: cint): cint {.cdecl, importc: "nk_tree_push_hashed",
                                       header: headernuklear.}
proc group_scrolled_end*(a1: ptr context) {.cdecl, importc: "nk_group_scrolled_end",
                                        header: headernuklear.}
proc group_scrolled_begin*(a1: ptr context; off: ptr scroll; title: cstring; a4: flags): cint {.
    cdecl, importc: "nk_group_scrolled_begin", header: headernuklear.}
proc group_scrolled_offset_begin*(a1: ptr context; x_offset: ptr uint;
                                 y_offset: ptr uint; title: cstring; flags: flags): cint {.
    cdecl, importc: "nk_group_scrolled_offset_begin", header: headernuklear.}
proc group_end*(a1: ptr context) {.cdecl, importc: "nk_group_end",
                               header: headernuklear.}
proc group_begin_titled*(a1: ptr context; name: cstring; title: cstring; a4: flags): cint {.
    cdecl, importc: "nk_group_begin_titled", header: headernuklear.}
proc group_begin*(a1: ptr context; title: cstring; a3: flags): cint {.cdecl,
    importc: "nk_group_begin", header: headernuklear.}
proc layout_space_rect_to_local*(a1: ptr context; a2: rect): rect {.cdecl,
    importc: "nk_layout_space_rect_to_local", header: headernuklear.}
proc layout_space_rect_to_screen*(a1: ptr context; a2: rect): rect {.cdecl,
    importc: "nk_layout_space_rect_to_screen", header: headernuklear.}
proc layout_space_to_local*(a1: ptr context; a2: vec2): vec2 {.cdecl,
    importc: "nk_layout_space_to_local", header: headernuklear.}
proc layout_space_to_screen*(a1: ptr context; a2: vec2): vec2 {.cdecl,
    importc: "nk_layout_space_to_screen", header: headernuklear.}
proc layout_space_bounds*(a1: ptr context): rect {.cdecl,
    importc: "nk_layout_space_bounds", header: headernuklear.}
proc layout_space_end*(a1: ptr context) {.cdecl, importc: "nk_layout_space_end",
                                      header: headernuklear.}
proc layout_space_push*(a1: ptr context; bounds: rect) {.cdecl,
    importc: "nk_layout_space_push", header: headernuklear.}
proc layout_space_begin*(a1: ptr context; a2: layout_format; height: cfloat;
                        widget_count: cint) {.cdecl,
    importc: "nk_layout_space_begin", header: headernuklear.}
proc layout_row_template_end*(a1: ptr context) {.cdecl,
    importc: "nk_layout_row_template_end", header: headernuklear.}
proc layout_row_template_push_static*(a1: ptr context; width: cfloat) {.cdecl,
    importc: "nk_layout_row_template_push_static", header: headernuklear.}
proc layout_row_template_push_variable*(a1: ptr context; min_width: cfloat) {.cdecl,
    importc: "nk_layout_row_template_push_variable", header: headernuklear.}
proc layout_row_template_push_dynamic*(a1: ptr context) {.cdecl,
    importc: "nk_layout_row_template_push_dynamic", header: headernuklear.}
proc layout_row_template_begin*(a1: ptr context; row_height: cfloat) {.cdecl,
    importc: "nk_layout_row_template_begin", header: headernuklear.}
proc layout_row*(a1: ptr context; a2: layout_format; height: cfloat; cols: cint;
                ratio: ptr cfloat) {.cdecl, importc: "nk_layout_row",
                                  header: headernuklear.}
proc layout_row_end*(a1: ptr context) {.cdecl, importc: "nk_layout_row_end",
                                    header: headernuklear.}
proc layout_row_push*(a1: ptr context; value: cfloat) {.cdecl,
...
proc layout_ratio_from_pixel*(a1: ptr context; pixel_width: cfloat): cfloat {.cdecl,
    importc: "nk_layout_ratio_from_pixel", header: headernuklear.}
proc layout_widget_bounds*(a1: ptr context): rect {.cdecl,
    importc: "nk_layout_widget_bounds", header: headernuklear.}
proc layout_reset_min_row_height*(a1: ptr context) {.cdecl,
    importc: "nk_layout_reset_min_row_height", header: headernuklear.}
proc layout_set_min_row_height*(a1: ptr context; height: cfloat) {.cdecl,
    importc: "nk_layout_set_min_row_height", header: headernuklear.}
proc window_show_if*(a1: ptr context; name: cstring; a3: show_states; cond: cint) {.cdecl,
    importc: "nk_window_show_if", header: headernuklear.}
proc window_show*(a1: ptr context; name: cstring; a3: show_states) {.cdecl,
    importc: "nk_window_show", header: headernuklear.}
proc window_collapse_if*(a1: ptr context; name: cstring; a3: collapse_states; cond: cint) {.
    cdecl, importc: "nk_window_collapse_if", header: headernuklear.}
proc window_collapse*(a1: ptr context; name: cstring; state: collapse_states) {.cdecl,
...
proc window_set_focus*(a1: ptr context; name: cstring) {.cdecl,
    importc: "nk_window_set_focus", header: headernuklear.}
proc window_set_size*(a1: ptr context; name: cstring; a3: vec2) {.cdecl,
    importc: "nk_window_set_size", header: headernuklear.}
proc window_set_position*(a1: ptr context; name: cstring; pos: vec2) {.cdecl,
    importc: "nk_window_set_position", header: headernuklear.}
proc window_set_bounds*(a1: ptr context; name: cstring; bounds: rect) {.cdecl,
    importc: "nk_window_set_bounds", header: headernuklear.}
proc item_is_any_active*(a1: ptr context): cint {.cdecl,
    importc: "nk_item_is_any_active", header: headernuklear.}
proc window_is_any_hovered*(a1: ptr context): cint {.cdecl,
    importc: "nk_window_is_any_hovered", header: headernuklear.}
proc window_is_active*(a1: ptr context; a2: cstring): cint {.cdecl,
    importc: "nk_window_is_active", header: headernuklear.}
proc window_is_hidden*(a1: ptr context; a2: cstring): cint {.cdecl,
    importc: "nk_window_is_hidden", header: headernuklear.}
proc window_is_closed*(a1: ptr context; a2: cstring): cint {.cdecl,
...
proc window_is_hovered*(a1: ptr context): cint {.cdecl,
    importc: "nk_window_is_hovered", header: headernuklear.}
proc window_has_focus*(a1: ptr context): cint {.cdecl, importc: "nk_window_has_focus",
    header: headernuklear.}
proc window_get_canvas*(a1: ptr context): ptr command_buffer {.cdecl,
    importc: "nk_window_get_canvas", header: headernuklear.}
proc window_get_content_region_size*(a1: ptr context): vec2 {.cdecl,
    importc: "nk_window_get_content_region_size", header: headernuklear.}
proc window_get_content_region_max*(a1: ptr context): vec2 {.cdecl,
    importc: "nk_window_get_content_region_max", header: headernuklear.}
proc window_get_content_region_min*(a1: ptr context): vec2 {.cdecl,
    importc: "nk_window_get_content_region_min", header: headernuklear.}
proc window_get_content_region*(a1: ptr context): rect {.cdecl,
    importc: "nk_window_get_content_region", header: headernuklear.}
proc window_get_panel*(a1: ptr context): ptr panel {.cdecl,
    importc: "nk_window_get_panel", header: headernuklear.}
proc window_get_height*(a1: ptr context): cfloat {.cdecl,
    importc: "nk_window_get_height", header: headernuklear.}
proc window_get_width*(a1: ptr context): cfloat {.cdecl,
    importc: "nk_window_get_width", header: headernuklear.}
proc window_get_size*(a1: ptr context): vec2 {.cdecl, importc: "nk_window_get_size",
    header: headernuklear.}
...
proc draw_next*(a1: ptr draw_command; a2: ptr buffer; a3: ptr context): ptr draw_command {.
    cdecl, importc: "nk__draw_next", header: headernuklear.}
proc draw_end*(a1: ptr context; a2: ptr buffer): ptr draw_command {.cdecl,
    importc: "nk__draw_end", header: headernuklear.}
proc draw_begin*(a1: ptr context; a2: ptr buffer): ptr draw_command {.cdecl,
    importc: "nk__draw_begin", header: headernuklear.}
proc convert*(a1: ptr context; cmds: ptr buffer; vertices: ptr buffer;
             elements: ptr buffer; a5: ptr convert_config): flags {.cdecl,
    importc: "nk_convert", header: headernuklear.}
proc next*(a1: ptr context; a2: ptr command): ptr command {.cdecl, importc: "nk__next",
    header: headernuklear.}
proc begin*(a1: ptr context): ptr command {.cdecl, importc: "nk__begin",
                                      header: headernuklear.}
proc input_end*(a1: ptr context) {.cdecl, importc: "nk_input_end",
                               header: headernuklear.}
proc input_unicode*(a1: ptr context; a2: rune) {.cdecl, importc: "nk_input_unicode",
    header: headernuklear.}
proc input_glyph*(a1: ptr context; a2: glyph) {.cdecl, importc: "nk_input_glyph",
    header: headernuklear.}
proc input_char*(a1: ptr context; a2: char) {.cdecl, importc: "nk_input_char",
                                        header: headernuklear.}
proc input_scroll*(a1: ptr context; val: vec2) {.cdecl, importc: "nk_input_scroll",
    header: headernuklear.}
proc input_button*(a1: ptr context; a2: buttons; x: cint; y: cint; down: cint) {.cdecl,
    importc: "nk_input_button", header: headernuklear.}
proc input_key*(a1: ptr context; a2: keys; down: cint) {.cdecl, importc: "nk_input_key",
    header: headernuklear.}
proc input_motion*(a1: ptr context; x: cint; y: cint) {.cdecl,
    importc: "nk_input_motion", header: headernuklear.}
proc input_begin*(a1: ptr context) {.cdecl, importc: "nk_input_begin",
                                 header: headernuklear.}
proc free*(a1: ptr context) {.cdecl, importc: "nk_free", header: headernuklear.}
proc clear*(a1: ptr context) {.cdecl, importc: "nk_clear", header: headernuklear.}
proc init_custom*(a1: ptr context; cmds: ptr buffer; pool: ptr buffer; a4: ptr user_font): cint {.
    cdecl, importc: "nk_init_custom", header: headernuklear.}
proc init*(a1: ptr context; a2: ptr allocator; a3: ptr user_font): cint {.cdecl,
    importc: "nk_init", header: headernuklear.}
proc init_fixed*(a1: ptr context; memory: pointer; size: size; a4: ptr user_font): cint {.
    cdecl, importc: "nk_init_fixed", header: headernuklear.}
proc init_default*(a1: ptr context; a2: ptr user_font): cint {.cdecl,

...
type
  plugin_alloc* = proc (a2: handle; old: pointer; a4: size): pointer  {.cdecl.}
  plugin_free* = proc (a2: handle; old: pointer)  {.cdecl.}
  plugin_filter* = proc (a2: ptr text_edit; unicode: rune): cint  {.cdecl.}
  plugin_paste* = proc (a2: handle; a3: ptr text_edit)  {.cdecl.}
  plugin_copy* = proc (a2: handle; a3: cstring; len: cint)  {.cdecl.}
...
type
  edit_types* {.size: sizeof(cint).} = enum
    ...
    EDIT_FIELD = EDIT_SIMPLE or EDIT_SELECTABLE or EDIT_CLIPBOARD, EDIT_BOX = EDIT_ALWAYS_INSERT_MODE or
        EDIT_SELECTABLE or EDIT_MULTILINE or EDIT_ALLOW_TAB or EDIT_CLIPBOARD, EDIT_EDITOR = EDIT_SELECTABLE or
        EDIT_MULTILINE or EDIT_ALLOW_TAB or EDIT_CLIPBOARD
...
type
  panel_set* {.size: sizeof(cint).} = enum
    PANEL_SET_NONBLOCK = PANEL_CONTEXTUAL or PANEL_COMBO or PANEL_MENU or
        PANEL_TOOLTIP, PANEL_SET_POPUP = PANEL_SET_NONBLOCK or PANEL_POPUP,
    PANEL_SET_SUB = PANEL_SET_POPUP or PANEL_GROUP
